		...
		<div class="contenido-tratamiento">
			...
			<div class="text-trat">
				<h2>¿Primera vez?</h2>
					...
					<p><img src="imagenes/primeravez.jpg"  align="right"></p><br>

					<p>Si es la primera vez que vas a empezar un tratamiento con nosotros te explicaremos cómo será el proceso.</p>

					<p>Primero te realizaremos un examen de valoración para observar el estado en el que se encuentran tus dientes. </p>

					<p>Luego se haría una limpieza general profunda, dejando los dientes blancos y libres de manchas.</p>

					<p>Lo segundo que haríamos seria tratar todas caries.</p>

					<p>Dependiendo del diagnostico de nuestro especialista se realizaría el respectivo procedimiento. </p><br>
