...
<body class="menu">
	...
	<nav>
		...
		<ul>
			...
			<li><a class="active" href="#">Tratamientos</a></li>
		...
		<div class="contenido-tratamiento">
			...
			<div class="text-trat">
				...
				<h2>Implantes</h2>
					...
					<p><img src="imagenes/implante.jpg"  align="right">La rehabilitación con implantes lleva en si dos eventos o actos principales:</p><br>

						<p>Un acto quirúrgico y un acto protésico. En el quirúrgico se realiza la colocación del tornillo dentro de la estructura ósea. En el protésico se coloca la prótesis fija – Corona atornillada directamente al implante</p><br>

			</div>

			<div class="text-trat">

				<h2>Implantes Gama Superior</h2>

					<p><img src="imagenes/implante superior.jpg"  align="left">Este tipo de implantes es una muy buena alternativa para los paciente pues incluye: Cirugía de implante, implante y Corona metal porcelana de excelente calidad.</p><br>

			</div>

			<div class="text-trat">	

				<h2>Implantes Gama Premium</h2>

					<p><img src="imagenes/implante premium.jpg" align="right">Los implantes dentales de Gama Premium incluyen: Cirugía de implante, implante dental y Corona en Zirconio.</p>
